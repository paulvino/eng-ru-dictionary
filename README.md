...
| router     | роутер, маршрутизатор (от слова _route_, маршрут)                                                                                                                   |
| redirect   | перенаправить                                                                                                                                                       |
| HTTP       | HyperText Transfer Protocol, протокол передачи данных                                                                                                               |
| HTTPS      | HyperText Transfer Protocol Secure, безопасный (более, чем HTTP) протокол передачи данных, который поддерживает шифрование; является расширенной версией HTTP       |
...
| count           | количество (например, элементов в массиве)                      |
| sort            | сортировать                                                     |
...
| REST                        | Representational State Transfer, согласованный набор архитектурных принципов для создания более масштабируемой и гибкой сети, вкратце: модель "клиент - сервер"; отсутствие состояния; кэширование; единообразие интерфейса; слои; код по требованию (необязательный)                                                                                                     |
